...
const P90_DATA: PlantData = {
  ...
  operationalRequirements: [
    ...
    { key: 'op_req_piping', value: 'Tubería de acero al carbón o acero inoxidable según requerimientos de presión' },
    { key: 'op_req_wiring', value: 'Sistema eléctrico trifásico de 220V/440V según especificaciones técnicas' },
    { key: 'op_req_gas_tank', value: 'Mínimo 100 kg para inicio de proceso' },
    { key: 'op_req_gasoline_storage', value: 'Recomendación: 500 litros (1 ciclo/día) (acero inoxidable o acero al carbón con recubrimiento epóxico)' },
    { key: 'op_req_diesel_storage', value: 'Recomendación: 300 litros (1 ciclo/día) (acero inoxidable o acero al carbón con recubrimiento epóxico)' },
    { key: 'op_req_kerosene_storage', value: 'Recomendación: 100 litros (1 ciclo/día) (acero inoxidable o acero al carbón con recubrimiento epóxico)' },
    { key: 'op_req_paraffin_storage', value: 'Contenedores metálicos reforzados de 200 litros' },
    { key: 'op_req_coke_storage', value: 'Costales industriales de 25-30 kg (área techada y ventilada)' },
    { key: 'op_req_space', value: 'Mínimo 100 m² techados y 200 m² de área total' },
    { key: 'op_req_ventilation', value: 'Sistema de extracción forzada según normativa NOM-005-STPS-1998' },
    { key: 'op_req_floor', value: 'De concreto pulido con canaletas de contención' },
    { key: 'op_req_drainage', value: 'Sistema de trampas de grasa y separadores de hidrocarburos' },
    { key: 'op_req_safety', value: 'Extintores Clase B y C, señalización y equipo de emergencia' },
  ],
...
const PETGAS_4K_DATA: PlantData = {
  ...
  operationalRequirements: [
    ...
    { key: 'op_req_gasoline_storage_6days', value: 'Recomendación tanque de 25,000 litros o 2 tanques de 12,000 litros (acero inoxidable o acero al carbón con recubrimiento epóxico)' },
    { key: 'op_req_diesel_storage_6days', value: 'Recomendación 15,000 litros (acero inoxidable o acero al carbón con recubrimiento epóxico)' },
    { key: 'op_req_kerosene_storage_6days', value: 'Recomendación 6,000 litros (acero inoxidable o acero al carbón con recubrimiento epóxico)' },
    { key: 'op_req_paraffin_storage', value: 'Contenedores metálicos reforzados de 200 litros' },
    { key: 'op_req_coke_storage', value: 'Costales industriales de 25-30 kg (área techada y ventilada)' },
  ],
...
const PETGAS_4K_2R_DATA: PlantData = {
  id: 'petgas-4k-2r',
  shortName: '4K - 2R',
  fullName: 'PETGAS 4K - 2R (Doble Reactor)',
  ...
  technicalSpecs: [
    ...
    { key: 'tech_spec_process_duration', value: '8 - 10 horas por ciclo' },
    { key: 'tech_spec_operators', value: '3 operadores por ciclo' },
    { key: 'tech_spec_burners', value: '2 quemadores Marca PETGAS' },
    { key: 'tech_spec_reactor_type', value: '2 reactores forrados en acero inoxidable' },
    { key: 'tech_spec_gasoline_prod', value: '3,600 litros' },
    { key: 'tech_spec_diesel_prod', value: '2,000 litros' },
    { key: 'tech_spec_kerosene_prod', value: '800 litros' },
    { key: 'tech_spec_paraffin_prod', value: '200 kilogramos' },
  ...
  powerAndEnergy: [
    { key: 'tech_spec_lp_gas_consumption', value: '30 Litros por hora. Consumo de gas LP entre 1 y 2 horas por encendido.' },
    { key: 'tech_spec_energy', value: '96 000 BTU (2 enfriadores, bombas, tableros, sensores)' },
    { key: 'tech_spec_power', value: '10 kW' },
  ],
  maintenance: [
    'maintenance_daily_inspection',
    'maintenance_valve_inspection_6months',
    'maintenance_seal_inspection_3months',
    'maintenance_connection_inspection_2_4months',
    'maintenance_gasket_replacement',
    'maintenance_coke_removal',
    'maintenance_thermoconverters_cleaning',
  ],
  consumables: [
    { key: 'consumable_gaskets', value: 'consumable_gaskets_recommendation_4k'}
  ],
  operationalRequirements: [
    { key: 'op_req_water', value: '2,400 Litros' },
    { key: 'op_req_piping', value: 'Tubería de acero al carbón o acero inoxidable según requerimientos de presión' },
    { key: 'op_req_wiring', value: 'Sistema eléctrico trifásico de 220V/440V según especificaciones técnicas' },
    { key: 'op_req_gas_tank', value: 'op_req_gas_tank_value_process_start' },
    { key: 'op_req_gasoline_storage_1week_dual', value: 'Recomendación 2 tanques de 25,000 litros o 4 tanques de 12,000 litros (acero inoxidable o acero al carbón con recubrimiento epóxico)' },
    { key: 'op_req_diesel_storage_1week_dual', value: 'Recomendación 30,000 litros (acero inoxidable o acero al carbón con recubrimiento epóxico)' },
    { key: 'op_req_kerosene_storage_1week_dual', value: 'Recomendación 12,000 litros (acero inoxidable o acero al carbón con recubrimiento epóxico)' },
    { key: 'op_req_paraffin_storage', value: 'Contenedores metálicos reforzados de 200 litros' },
    { key: 'op_req_coke_storage', value: 'Costales industriales de 25-30 kg (área techada y ventilada)' },
    { key: 'op_req_space', value: 'Mínimo 150 m² techados y 300 m² de área total' },
    { key: 'op_req_ventilation', value: 'Sistema de extracción forzada según normativa NOM-005-STPS-1998' },
    { key: 'op_req_floor', value: 'De concreto pulido con canaletas de contención' },
    { key: 'op_req_drainage', value: 'Sistema de trampas de grasa y separadores de hidrocarburos' },
    { key: 'op_req_safety', value: 'Extintores Clase B y C, señalización y equipo de emergencia' },
  ...
  productionAnalysis: {
    ...
    tables: [
      {
        id: 'pa1_4k_2r', 
        titleKey: 'prod_analysis_table_4k_main_title',
        data: [
          { concept: 'prod_analysis_op_days_estimated', specification: '26 días laborables' },
          { concept: 'prod_analysis_kg_transformed_day_4k', specification: '16,000 kg por día' },
          { concept: 'prod_analysis_gasoline_monthly_4k', specification: '187,200 litros' },
          { concept: 'prod_analysis_diesel_monthly_4k', specification: '104,000 litros' },
          { concept: 'prod_analysis_kerosene_monthly_4k', specification: '41,600 litros' },
          { concept: 'prod_analysis_paraffin_monthly_4k', specification: '10,400 kg' },
          { concept: 'prod_analysis_coke_monthly_4k', specification: '14,560 kg' },
          { concept: 'prod_analysis_manpower_per_cycle', specification: '4 personas por turno' },
        ]
      }
    ]
  },
  priceInfoKey: 'petgas_4k_2r_price_info',
};

export const ALL_PLANTS_DATA: PlantData[] = [P90_DATA, PETGAS_4K_DATA, PETGAS_4K_2R_DATA];
